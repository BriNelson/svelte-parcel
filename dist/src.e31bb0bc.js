...
function get_each_context(ctx, list, i) {
  ...
  child_ctx[9] = i;
  return child_ctx;
} // (38:0) {#each todoList as item, index}
...
function create_each_block(ctx) {
  ...
  var block = {
    c: function create() {
      ...
      (0, _internal.attr_dev)(div0, "class", "me-5 svelte-u8ushy");
      (0, _internal.toggle_class)(div0, "status",
      /*item*/
      ctx[7].competed);
      (0, _internal.add_location)(div0, file, 40, 4, 943);
      (0, _internal.attr_dev)(button0, "type", "button");
      (0, _internal.attr_dev)(button0, "class", "btn btn-danger");
      (0, _internal.add_location)(button0, file, 40, 69, 1008);
      (0, _internal.attr_dev)(button1, "class", "btn btn-success");
      (0, _internal.add_location)(button1, file, 40, 163, 1102);
      (0, _internal.attr_dev)(div1, "class", "d-flex flex-row list-group-item");
      (0, _internal.add_location)(div1, file, 39, 2, 892);
    },
    m: function mount(target, anchor) {
      ...
      if (!mounted) {
        dispose = [(0, _internal.listen_dev)(button0, "click", click_handler, false, false, false), (0, _internal.listen_dev)(button1, "click", click_handler_1, false, false, false)];
        mounted = true;
      }
    },
    p: function update(new_ctx, dirty) {
      ...
      2 && t0_value !== (t0_value =
      /*item*/
      ctx[7].todo + "")) (0, _internal.set_data_dev)(t0, t0_value);
  ...
  (0, _internal.dispatch_dev)("SvelteRegisterBlock", {
    ...
    type: "each",
    source: "(38:0) {#each todoList as item, index}",
    ctx: ctx
  });
  return block;
}
...
function create_fragment(ctx) {
  ...
  var block = {
    c: function create() {
      ...
      (0, _internal.add_location)(input, file, 26, 4, 640);
      (0, _internal.attr_dev)(div0, "class", "col");
      (0, _internal.add_location)(div0, file, 25, 4, 617);
      (0, _internal.attr_dev)(button, "class", "btn btn-primary");
      (0, _internal.add_location)(button, file, 30, 4, 746);
      (0, _internal.attr_dev)(div1, "class", "col");
      (0, _internal.add_location)(div1, file, 28, 4, 719);
      (0, _internal.attr_dev)(div2, "class", "row");
      (0, _internal.add_location)(div2, file, 24, 2, 594);
      (0, _internal.add_location)(form, file, 23, 0, 545);
      (0, _internal.attr_dev)(div3, "class", "list-group");
      (0, _internal.add_location)(div3, file, 35, 0, 827);
      (0, _internal.attr_dev)(div4, "class", "container");
      (0, _internal.add_location)(div4, file, 22, 0, 520);
    },
    ...
    p: function update(ctx, _ref) {
      ...
      if (dirty &
      /*completeTodo, todoList, removeTodo*/
      10) {
        each_value =
        /*todoList*/
        ctx[1];
...
function instance($$self, $$props, $$invalidate) {
  ...
  return [newTodo, todoList, handleClick, removeTodo, input_input_handler, click_handler, click_handler_1];
}
